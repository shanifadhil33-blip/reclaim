    ...
    <div className="min-h-screen flex items-center justify-center bg-neutral-950 p-4 font-sans relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-white/10 bg-white/5 backdrop-blur-xl text-white relative z-10">
        <form onSubmit={handleAuth}>
          ...
          <CardFooter className="flex flex-col space-y-4 pt-4 mb-2">
            <Button type="submit" className="w-full h-12 text-md transition-all hover:scale-[1.02] active:scale-[0.98] bg-white text-black hover:bg-neutral-200 shadow-[0_0_20px_rgba(255,255,255,0.1)]" disabled={loading}>
            ...
            <div className="relative w-full py-2">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-neutral-900/50 backdrop-blur-xl px-2 text-neutral-400">Or continue with</span>
              </div>
            </div>
            ...
            <Button
              ...
              disabled={loading}
              className="w-full h-12 text-md bg-transparent border-white/20 text-white hover:bg-white/5 transition-all flex items-center justify-center gap-2"
            >
